function type_middle_color(x, y, _text, _progress, _width, _c1, _c2, _c3, _c4) {
	var _draw_x = 0;
	var _draw_y = 0;
	...
	for (var _i = 1; _i <= _progress; _i++;)
	{
		...
		{
			draw_text_color(x + _draw_x - _line_progress[_lines]*0.5, y + _draw_y - array_length(_line_progress)*string_height("A")/2, _char, _c1, _c2, _c3, _c4,1);
			_draw_x += string_width(_char);
		}
	}
}
