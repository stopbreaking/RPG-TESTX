function type_hopping_letters_anim_curve_proper(x, y, _text, _progress, _width, _hop_progress, _hop_delay, _hop_height, _curve) {
	var _draw_x = 0;
	var _draw_y = 0;
	...
	for (var _i = 1; _i <= _progress; _i++;)
	{
		...
		{
			draw_text(x + _draw_x, y + _draw_y - _hop_height * animcurve_channel_evaluate(_cuv, clamp((_hop_progress), 0, 1)), _char);	
			_hop_progress -= (_hop_delay);
			_draw_x += string_width(_char);
		}
	}
